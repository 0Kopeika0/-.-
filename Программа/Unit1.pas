...
// АЛГОРИТМ ПО ОТКРЫТИЮ ФАЙЛА ПОМОЩЬ
// ----------------------------------------------------------------------------//
procedure TForm1.N4Click(Sender: TObject);
var name:string;
begin
  name:='C:\Users\Иван\Desktop\Язык С и Дельфи\Курсовая\Программа\Помощь.docx';
...
begin
  n:= StrToInt(Edit1.Text);
  SetLength(C,n);
  { Определение размера массива B (N) и его заполнение }
  SetLength(B,n);
  for i := 1 to n do
  ...
  memoryB:=@B; // запись в переменную адрес массива B
  memoryC:=@C; // запись в переменную адрес массива C
...
var
  ...
  Elapsed: cardinal;
begin
  { Определение размера массива D (N) и его заполнение }
  n := StrToInt(Edit1.Text);
  SetLength(D,n);
  for i := 1 to n do
  ...
  memoryD:=@D; // запись в переменную адрес массива D
  ...
  { Вывод отсортированного массива D }
  for i := 1 to n do
...
var
  ...
  Elapsed: cardinal;
begin
  { Определение размера массива E и его заполнение }
  n := StrToInt(Edit1.Text);
  SetLength(E,n);
  for i := 1 to n do
  ...
  memoryE:=@E; // запись в переменную адрес массива E
  ...
  { Вывод отсортированного массива E }
  for i := 1 to n do
...
Begin
  ...
  SetLength(H,n);
  SetLength(CC,n);
  { Определение размера массива F(N) и его заполнение }
  SetLength(F,n);
  for i := 1 to n do
  ...
  memoryF:=@F; // запись в переменную адрес массива F
  memoryH:=@H; // запись в переменную адрес массива H
