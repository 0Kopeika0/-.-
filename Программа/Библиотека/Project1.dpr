...
begin
  if first < last then
  begin
    MergeSort(AA, first, (first + last) div 2); { сортировка левой части }
    MergeSort(AA, (first + last) div 2 + 1, last); { сортировка правой части }
    Merge(AA, first, last); { слияние двух частей }
  end;
end;
